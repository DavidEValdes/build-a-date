  ...
  try {
    ...
    const sampleDateIdeas = [
      ...
      // 101
      {
        ...
        description:
          "Walk among beautiful butterflies in a serene conservatory.",
        location: "indoor",
        cost_category: "standard",
        duration: "1-2 hours",
      ...
      // 146
      {
        ...
        description:
          "Witness the latest fashion trends at a local runway show.",
        location: "indoor",
        cost_category: "premium",
        duration: "2-3 hours",
        activity_type: "fashionShow",
      ...
      // 163
      {
        ...
        description:
          "Explore the brewing process and taste various craft beers.",
        location: "indoor",
        cost_category: "standard",
        duration: "2-3 hours",
        activity_type: "breweryTour",
